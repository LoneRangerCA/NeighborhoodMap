...
var ViewModel = function() {
    ...
    self.placeList().forEach(function(placeItem) {
        ...
        //http://stackoverflow.com/questions/35026964/what-is-wrong-with-my-foursquare-api-call
        //json call
        $.ajax({
            ...
            error: function(e) {
                infowindow.setContent('<h5>Foursquare load failed.</h5>');
                document.getElementById("error").innerHTML = "<h4>Foursquare load failed</h4>";
            }
        });

//Open infowindow on listbox or marker click
